<?php
$page1 = "adminAddUser.php";
 include 'includes/adminHeader.php';
include 'includes/adminparseAdduser.php';
...
<section>
            <div class="container container-sign-up text-center">
                ...
                <?php if(!empty($errors)) echo show_errors($errors); ?>
                    ...
                    <div class="col-sm-12">
                        <label for="inputrole" class="form-label state ">Role</label>
                        ...
                        <div class="col-sm-12 form-floating"> 
                            <input type="text" name="meterid" class="form-control" id="meter_id-input" placeholder="Meter ID">
                        ...
                        <div class="col-sm-3 form-floating">
                            <input type="text"  class="form-control" id="country-code" placeholder="+234" disabled>
