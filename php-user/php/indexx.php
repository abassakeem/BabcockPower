...
<body class="p-0">
    ...
    <div>
        <div class="section  section1 container-fluid bg-light">
            <div class="row vh-100  justify-content-around align-items-center ">
              
                <div class="col-xs-12 col-sm-6 text-dark text-center">
                  ...
                  <div class="col-xs-12 col-sm-6">
                    <img class="img-fluid justify-self-center align-items-center" src="../abass svg for project/undraw_electricity_k2ft.svg">
                </div>
                <div class="bulb">
                <div  >
...
<!-- END Lamp -->
            ...
            <div class="container text-center">
                ...
                <div class="row justify-content-center align-items-start ">
                    <div class="col-xs-12 col-sm-4">
                        ...
                        <a href="#" class="links">100% Secure</a>
                        <p>The system is confidential.</p>
                    </div>
                    <div class="col-xs-12 col-sm-4 ">
                        <img class="feature-icon" src="../abass svg for project/icons8-clock.svg"/><br>
                        <a href="#" class="links">Faster Payments</a>
                        <p>Babcock Power brings speed and scalability  that allows to process several transactions .</p>
                    </div>
                    <div class="col-xs-12 col-sm-4">
        ...
        <footer class="page-footer text-center">
            <p><small>Babacock Power. Copyright © 2023</small></p>
        </footer>
    </div>
